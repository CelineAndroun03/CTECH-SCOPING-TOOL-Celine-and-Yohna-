...
distribution = {} #THIS IS TO BE DETERMINED, IT IS NOT WORKING RIGHT NOW... I WILL MESSAGE U ABOUT IT
...
# 1) Plot the frequency of each investigation type
...
#2)  Plot the average of actual hours for each of these types (total, lab, eng)
